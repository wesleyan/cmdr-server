...
module Wescontrol
    module RoomtrolServer
        class AuthServer < Sinatra::Application
            ...
            # Use couchdb replication filters to push configuration settings from server to device.
            # To push configuration documents initiate a POST request with data "room_id" => room_id_key.
            post '/config/sync' do
